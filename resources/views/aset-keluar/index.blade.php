<x-app-layout>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2 space-x-2">
                           <a href="{{ route('aset-keluar.edit', $asetKeluar) }}"
                            ...
                            <form action="{{ route('aset-keluar.return', $asetKeluar) }}" method="POST"
                                class="inline return-form">
                                @csrf
                                <button type="submit" class="bg-green-500 text-white p-2 my-1 rounded-lg">Kembalikan</button>
                            </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            // SweetAlert2 for Return Confirmation
$('.return-form').on('submit', function(e) {
    ...
    Swal.fire({
        ...
        text: "Jumlah aset akan dikembalikan ke stok.",
        icon: 'question',
        showCancelButton: true,
