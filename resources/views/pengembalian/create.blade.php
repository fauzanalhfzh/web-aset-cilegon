    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <form action="{{ route('pengembalian.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="aset_keluar_id" id="aset_keluar_id" class="w-full border rounded-lg p-2">
                    @foreach ($asetKeluars as $asetKeluar)
                        <option value="{{ $asetKeluar->id }}">{{ $asetKeluar->aset->nama_aset }} (Keluar: {{ $asetKeluar->jumlah }})</option>
                    @endforeach
                </select>
            ...
            <div class="mb-4">
                ...
                <input type="date" name="tanggal_pengembalian" id="tanggal_pengembalian" class="w-full border rounded-lg p-2" value="{{ old('tanggal_pengembalian') }}">
